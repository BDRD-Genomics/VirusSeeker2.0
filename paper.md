...
[Table 1](#Table-1) summarizes the degree to which all evaluated tools identified the target species or a closely related near-neighbor. 
  ...
  - These results demonstrate the complementary nature of `VirusSeeker 2.0` to MetaDetector because it provides rigorous false-positive filtering to optimize for the detection of low-abundance novel viruses amid high background, while MetaDetector excels more broadly at assembly and contig recovery for all domains of life.
