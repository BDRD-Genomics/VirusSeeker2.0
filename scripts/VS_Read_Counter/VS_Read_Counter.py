...
outfile.write("Organism\tTotal Read Count\tSingle Read Count\tJoined Read Count\tContig Read Count" +"\n")
        ...
        if line.startswith(">"):
            if line.startswith(">un"): #singletons count as 1
                ...
                try:
                    ...
                    continue
        if line.startswith("#####"):
            outfile.write(organism_classifications + "\t" + str(count) + "\t" + str(un_count) + "\t" + str(join_count) + "\t" + str(contig_count) + "\n")
            at_organism = False
