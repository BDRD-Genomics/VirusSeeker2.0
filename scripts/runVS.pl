...
# based on percentage of reads left for analysis at each step from MiSeq run 1 data. 
# This number should be bigger to make sure each file does not have too many reads.
my $file_number_of_MMseqs_NT = 50;
...
my $MMseqs_NT_dir = $sample_dir."/".$sample_name."_MMseqs2_NT";
...
sub parse_MMseqs_VIRUSDB {
	...
	print STCH "MMseqsIN=",'${MMseqs_VIRUSDB_DIR}',"/",$sample_name.".goodSeq.fa_file".'${SLURM_ARRAY_TASK_ID}',".fasta\n";#full path
...
#	print STCH "		".$run_script_path."MMseqs_VIRUSDB_parser.pl.test.sqlite ".$sample_dir."/".$sample_name.$MMseqs_VIRUSDB_DIR_SUFFIX." \${MMseqsOUT}\n";
	...
	print STCH '		CHECK=$?',"\n";
	print STCH "    	mv \$MMseqs_VIRUSDB_Filtered_fa \${MMseqs_VIRUSDB_Filtered_fa}.temp1.fasta\n";
	print STCH "    	awk '{print \$1}' \${PARSED} > \${PARSED}.queries.txt\n";
	print STCH "    	$seqkit \${PARSED}.queries.txt \${MMseqsIN} -o \${MMseqs_VIRUSDB_Filtered_fa}.temp2.fasta\n";
	print STCH "    	cat \${MMseqs_VIRUSDB_Filtered_fa}.temp1.fasta \${MMseqs_VIRUSDB_Filtered_fa}.temp2.fasta > \${MMseqs_VIRUSDB_Filtered_fa}\n";
	print STCH "    	mv \${MMseqs_VIRUSDB_Filtered_fa}.temp1.fasta \${MMseqs_VIRUSDB_Filtered_fa}.temp1.out\n";
	print STCH "    	mv \${MMseqs_VIRUSDB_Filtered_fa}.temp2.fasta \${MMseqs_VIRUSDB_Filtered_fa}.temp2.out\n";	
...
sub parse_BLASTX_VIRUSDB {
	...
	print STCH "BLASTX_VIRUSDB_IN=",'${VIRUS_DIR}',"/",$sample_name.".MMseqs_VIRUSDB_Filtered.fa_file".'${SLURM_ARRAY_TASK_ID}',".fasta\n"; #full path
	...
	print STCH "			exit 1\n"; # exit
	print STCH "		fi\n";
	#patchwork fix to save fasta reads that had no hits; QKT
	print STCH "    	mv \$BLASTX_VIRUSDB_Filtered_fa \${BLASTX_VIRUSDB_Filtered_fa}.temp1.fasta\n";
	print STCH "    	awk '{print \$1}' \${PARSED} > \${PARSED}.queries.txt\n";
	print STCH "    	$seqkit \${PARSED}.queries.txt \${BLASTX_VIRUSDB_IN} -o \${BLASTX_VIRUSDB_Filtered_fa}.temp2.fasta\n";
	print STCH "    	cat \${BLASTX_VIRUSDB_Filtered_fa}.temp1.fasta \${BLASTX_VIRUSDB_Filtered_fa}.temp2.fasta > \${BLASTX_VIRUSDB_Filtered_fa}\n";
	print STCH "    	mv \${BLASTX_VIRUSDB_Filtered_fa}.temp1.fasta \${BLASTX_VIRUSDB_Filtered_fa}.temp1.out\n";
	print STCH "    	mv \${BLASTX_VIRUSDB_Filtered_fa}.temp2.fasta \${BLASTX_VIRUSDB_Filtered_fa}.temp2.out\n";
	#end insertion; QKT
	#if the parsed file exists, check the completeness of the parsed file
	print STCH "	else\n";
	print STCH "		".$run_script_path."check_Blast_parsed_file.pl \${PARSED}\n";
...
sub parse_MMseqs_NT{
    ...
    print STCH "MMseqs_Filtered_fa=",'${MMseqs_DIR}',"/".$sample_name.".VIRUSDB_HIT.fa_file".'${SLURM_ARRAY_TASK_ID}',".MMseqs_filtered.fa\n\n";
	...
	print STCH '		CHECK=$?',"\n";
	#patchwork fix to save fasta reads that had no hits; QKT
	print STCH "		mv \$MMseqs_Filtered_fa \${MMseqs_Filtered_fa}.temp1.fasta\n";
	print STCH "		awk '{print \$1}' \${PARSED} > \${PARSED}.queries.txt\n";
	print STCH "		$seqkit \${PARSED}.queries.txt \${QUERY} -o \${MMseqs_Filtered_fa}.temp2.fasta\n";
    print STCH "		cat \${MMseqs_Filtered_fa}.temp1.fasta \${MMseqs_Filtered_fa}.temp2.fasta | seqkit rmdup -o \${MMseqs_Filtered_fa}\n";
	print STCH "		mv \${MMseqs_Filtered_fa}.temp1.fasta \${MMseqs_Filtered_fa}.temp1.out\n";
	print STCH "		mv \${MMseqs_Filtered_fa}.temp2.fasta \${MMseqs_Filtered_fa}.temp2.out\n";
	#end insertion; QKT
	#check if parsed file is completed. If not completed, exit.
	print STCH '		if [ ${CHECK} -ne 0 ]',"\n";   
	print STCH "		then\n";
...
sub pool_split_for_BLASTX{
	...
	print STCH "MMseqs_DIR=".$MMseqs_dir_NT."\n";
	print STCH "MMSeqs_Filtered_fa=".$sample_name.".VIRUSDB_HIT_MMseqs_NT_Filtered.fa\n";
...
sub parse_BLASTX{
	...
	print STCH "BlastXIN=",'${BX_DIR}',"/".$sample_name.".MMseqs_NT_Filtered.fa_file".'${SLURM_ARRAY_TASK_ID}',".fasta\n";
	...
	print STCH '		python '.$bash_bin_path."/BLAST_NT_NR_parser.py "."\${BX_DIR} \${BlastXOUT}\n";
	print STCH "		".$run_script_path."check_Blast_parsed_file.pl  \${PARSED}\n";
	print STCH '		CHECK=$?',"\n";
	#check if parsed file is completed. If not completed, exit.
	print STCH "            mv \$BLASTX_Filtered_fa \${BLASTX_Filtered_fa}.temp1.fasta\n";
	print STCH "            if [ `wc -l \${PARSED} | awk '{print \$1}'` -gt 1 ]\n";
	print STCH "            then\n";
	print STCH "            	awk '{print \$1}' \${PARSED} > \${PARSED}.queries.txt\n";
	print STCH "            	$seqkit \${PARSED}.queries.txt \${BlastXIN} -o \${BLASTX_Filtered_fa}.temp2.fasta\n";
	print STCH "            	cat \${BLASTX_Filtered_fa}.temp1.fasta \${BLASTX_Filtered_fa}.temp2.fasta | seqkit rmdup -o \${BLASTX_Filtered_fa}\n";
	print STCH "            	mv \${BLASTX_Filtered_fa}.temp1.fasta \${BLASTX_Filtered_fa}.temp1.out\n";
	print STCH "            	mv \${BLASTX_Filtered_fa}.temp2.fasta \${BLASTX_Filtered_fa}.temp2.out\n";
	print STCH "            else\n";
	print STCH "                cat \${BLASTX_Filtered_fa}.temp1.fasta | seqkit rmdup -o \${BLASTX_Filtered_fa}\n";
	print STCH "                mv \${BLASTX_Filtered_fa}.temp1.fasta \${BLASTX_Filtered_fa}.temp1.out\n";
	print STCH "            fi\n";
	print STCH '		if [ ${CHECK} -ne 0 ]',"\n";   
	print STCH "		then\n";
	...
	print STCH "            	then\n";
	print STCH "            		awk '{print \$1}' \${PARSED} > \${PARSED}.queries.txt\n";
	print STCH "            		$seqkit \${PARSED}.queries.txt \${BlastNIN} -o \${BLASTX_Filtered_fa}.temp2.fasta\n";
	print STCH "            		cat \${BLASTX_Filtered_fa}.temp1.fasta \${BLASTX_Filtered_fa}.temp2.fasta | seqkit rmdup -o \${BLASTX_Filtered_fa}\n";
	print STCH "            		mv \${BLASTX_Filtered_fa}.temp1.fasta \${BLASTX_Filtered_fa}.temp1.out\n";
	print STCH "            		mv \${BLASTX_Filtered_fa}.temp2.fasta \${BLASTX_Filtered_fa}.temp2.out\n";
	print STCH "            	else\n";
	...
	print STCH "    then\n";
	print STCH "            cp \${BlastXIN} \${BLASTX_Filtered_fa}\n";
	print STCH "    fi\n";
	print STCH "fi";
	close STCH;
	$last_jobid1 = `sbatch $job_files_dir/$current_job_file1 | awk '{ print \$NF }'`;
