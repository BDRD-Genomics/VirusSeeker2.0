...
def getAssignment(formatted_lineage):
    assignment =""
    if "Metazoa" and "Homo" in formatted_lineage and formatted_lineage.startswith("cellular organisms;Eukaryota"):
        assignment="Human"
    elif "Metazoa" and "Mus" in formatted_lineage and formatted_lineage.startswith("cellular organisms;Eukaryota"):
        assignment="Mouse"
    elif formatted_lineage.startswith("cellular organisms;Eukaryota;Opisthokonta;Fungi"):
        assignment="Fungi"
    elif "Metazoa" in formatted_lineage and formatted_lineage.startswith("cellular organisms;Eukaryota"):
        assignment="Other"
    elif formatted_lineage.startswith("cellular organisms;Bacteria"):
        assignment="Bacteria"
...
total_records = blast_df["qseqid"].nunique()

# Select the rows using the obtained indices
#remove rows that do not meet evalue cutoff
