...
print OUT "column 1: #total: total number of reads in pairs obtained for this sample.\n";
...
print OUT "column 6: #QC: number of reads left after quality control (removing low quality nt and read,\n low complexity read, exact duplicates etc)\n";
print OUT "column 7: %Stitched: percentage of reads left after quality control (reads left after quality\n control divided by total number of reads after join read 1 and 2 (column 5)\n";
print OUT "column 8: #mapped: number of reads mapped to reference genome\n";
print OUT "column 9: %Stitched: percentage of mapped reads over total reads after stitching\n";
print OUT "column 10: #unmapped: number of reads not mapped to reference genome\n";
print OUT "column 11: %Stitched: percentage of reads not mapped to reference genome\n";
print OUT "column 12: #unique: number of unique reads after removing redundancy using CD-HIT\n";
print OUT "column 13: %Stitched: percentage of deduplicated reads (reads left after deduplication\n divided by total number of reads after join read 1 and 2 (column 5)\n";
print OUT "column 14: sample: name of the sample\n\n";


print OUT "Second Subsection: information about asembled contigs, singletons and outliers.\n";
print OUT "column 1: #uniqueAndTopSimilar: number of deduplicated reads + top 3 longest similar reads.\n";
print OUT "column 2: #contig: number of total contigs obtained\n";
print OUT "column 3: #SingletonOutlier: total number of singletons and outliers\n";
print OUT "column 4: #CSO: total number of contigs, singletons and outliers (#CSO)\n";
print OUT "column 5: %total(RawReads): percentage of #CSO out of total raw reads in one end file (to \n see how much data reduction was achieved)\n";
print OUT "column 6: #unique: number of unique sequences after CD-HIT\n";
print OUT "column 7: %total(#CSO): percentage of unique sequences (unique sequence divided by total #CSO)\n";
print OUT "column 8: #RMFiltered: number of MFilteredsidered as low complexity by RepeatMasker.\n";
print OUT "column 9: %unique: percentage of #RMFiltered reads over total number of deduplicated reads (column 6)\n";
print OUT "column 10: #good: number of good quality reads after RepeatMasker filtering low complexity sequence.\n";
print OUT "column 11: %unique: percentage of #good reads over total number of deduplicated reads (column 6)\n";
print OUT "column 12: sample name \n\n";


print OUT "Third Subsection: information about BLAST results.\n";
print OUT "column 1: #BN_VIRUSDB_Hit: number of reads have significant hit in BLASTn Virus-only database\n";
print OUT "column 2: #BX_VIRUSDB_Hit: number of reads have significant hit in BLASTx Virus-only database\n";
print OUT "column 3: #Total_VIRUSDB_Hit: number of reads have significant hit in both BLASTn \n and BLASTx Virus-only database (candidate eukaryotic viral sequences)\n";
print OUT "column 4: %unique: percentage of #Total_VIRUSDB_Hit reads over total number of \n deduplicated contigs/reads\n";
print OUT "column 5: #BNinput: number of reads entered BLASTn NT step\n";
print OUT "column 6: %VIRUSDB_Hit: percentage of #BNinput over total number of candidate \n eukaryotic viral sequences (column 3)\n";
print OUT "column 7: BXinput: number of reads entered BLASTx NR step\n";
print OUT "column 8: %VIRUSDB_Hit: percentage of BXinput over total number of candidate \n eukaryotic viral sequences (column 3)\n";
print OUT "column 9: Unassigned: number of reads that do not have sequence similarity with \n anything in the database.\n";
print OUT "column 10: %VIRUSDB_Hit: percentage of Unassigned over total number of candidate \n eukaryotic viral sequences (column 3)\n";
...
sub generate_SequenceReport {
	...
	printf OUT "%s\t%s\t%s\t%s\t%s\t", "#totalPair", "#unjoined", "#joined", "%total", "#TotalAfterStitch";
	printf OUT  "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n", "#QC", "%Stitched" , "#mapped", "%Stitched", "#unmapped", "%Stitched" , "#unique", "%Stitched";
	...
	printf OUT "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",  "#uniqueAndTopSimilar", "#contig", "#SingletonOutlier", "#CSO", "%total(RawReads)","#unique", "%total(#CSO)", "#RMFiltered", "%unique" ,  "#good", "%unique" ; 
	...
	printf OUT "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n", "#BN_VIRUSDB_Hit", "#BX_VIRUSDB_Hit", "Total_VIRUSDB_Hit", "%unique","#BNinput", "%VIRUSDB_Hit", "BXinput", "%VIRUSDB_Hit", "Unassigned", "%VIRUSDB_Hit", "\n", ; 
